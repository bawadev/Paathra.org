                ...
                <CardContent>
                  <div className="space-y-4">
                    {dailySchedule.morning && (
                      <div>
                        <h4 className="font-semibold text-gray-900">{t('morning')}</h4>
                        <p className="text-gray-600">{dailySchedule.morning}</p>
                      </div>
                    )}
                    {dailySchedule.afternoon && (
                      <div>
                        <h4 className="font-semibold text-gray-900">{t('afternoon')}</h4>
                        <p className="text-gray-600">{dailySchedule.afternoon}</p>
                      </div>
                    )}
                    {dailySchedule.evening && (
                      <div>
                        <h4 className="font-semibold text-gray-900">{t('evening')}</h4>
                        <p className="text-gray-600">{dailySchedule.evening}</p>
                      </div>
                    )}
                  </div>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="prose prose-sm max-w-none">
                    <p className="text-gray-700 whitespace-pre-line">{monastery.rules_guidelines}</p>
                  </div>
                </CardContent>
              </Card>
            )}
              ...
              <CardContent className="space-y-4">
                ...
                {monastery.phone && (
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`tel:${monastery.phone}`} className="text-sm text-blue-600 hover:underline">
                      {monastery.phone}
                    </a>
                  </div>
                )}
                ...
                {monastery.email && (
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`mailto:${monastery.email}`} className="text-sm text-blue-600 hover:underline">
                      {monastery.email}
                    </a>
                  </div>
                )}
                ...
                {monastery.website && (
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={monastery.website} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-600 hover:underline">
                      {monastery.website}
                    </a>
                  </div>
                )}
              ...
              <CardContent className="space-y-4">
                {monastery.monk_count && (
                  <div className="flex justify-between">
                    <span className="text-gray-600">{t('monks')}</span>
                ...
                <CardContent>
                  <div className="flex space-x-4">
                    {socialMedia.facebook && (
                      <a href={socialMedia.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600">
                    ...
                    {socialMedia.twitter && (
                      <a href={socialMedia.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-blue-600">
                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    {socialMedia.instagram && (
                      <a href={socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-pink-600">
                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  {monastery.contact_person_role && (
                    <p className="text-sm text-gray-600">{monastery.contact_person_role}</p>
                  )}
                </CardContent>
              </Card>
            )}
